...
Insert the following code in the `head` section of your pages:
    ...
    <link rel="mask-icon" href="/Dfv87ZbNh2/safari-pinned-tab.svg" color="#018c77">
    <link rel="shortcut icon" href="/Dfv87ZbNh2/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="Farol">
    <meta name="application-name" content="Farol">
    <meta name="msapplication-TileColor" content="#018c77">
    <meta name="msapplication-config" content="/Dfv87ZbNh2/browserconfig.xml">
    <meta name="theme-color" content="#018c77">
