		...
		if (stars > -1){
					...
					$('.button-evaluation').each(function(index){
						if (index < full_star){
							...
							$(".button-evaluation").eq(index).addClass('fas fa-star')
						}
						if(index > full_star && index< half_star){
							$(".button-evaluation").eq(index).removeClass('far fa-star')
							$(".button-evaluation").eq(index).addClass('fas fa-star-half-alt')
						}
						if( index> full_star+half_star && index < empty_star){
						}
					})	
				}	
	}else{
