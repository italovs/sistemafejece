...
Rails.application.routes.draw do
  ...
  devise_scope :admin do
    authenticated :admin do
      ...
      post '/posts_from_season', to: 'site#posts_from_season', as: 'admin_posts_from_season'
      ...
      post '/my_seasons_by_serie', to: 'site#my_seasons_by_serie', as: 'admin_my_seasons_by_serie'
    ...
    unauthenticated :admin do
      devise_scope :member do
        authenticated :member do
          ...
          post '/posts_from_season', to: 'site#posts_from_season', as: 'member_posts_from_season'
